 ...
 * @since 1.12.7
 */
public class FilterBeanToMapBuilder extends SimpleBeanToMapBuilder<Filter>{

    /** Static instance. */
    // the static instance works for all types
    public static final BeanToMapBuilder<Filter> INSTANCE = new FilterBeanToMapBuilder();
