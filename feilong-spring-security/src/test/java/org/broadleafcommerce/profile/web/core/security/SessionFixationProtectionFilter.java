...
//
//            String activeIdCookieValue = CookieUtil.getCookieValue(request, COOKIE_NAME);
...
//            String token = RandomGenerator.generateRandomId("SHA1PRNG", 32);
//
...
//            cookieEntity.setName(COOKIE_NAME);
//            cookieEntity.setValue(encryptedActiveIdValue);
//            cookieEntity.setSecure(true);
//
...
//
//        CookieUtil.deleteCookie(COOKIE_NAME, response);
//
