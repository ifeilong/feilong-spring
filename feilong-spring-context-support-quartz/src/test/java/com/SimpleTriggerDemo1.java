...
public class SimpleTriggerDemo1{
    ...
    public void run() throws SchedulerException{
        ...
        scheduler.scheduleJob(jobDetail, buildTrigger1());
        scheduler.scheduleJob(buildTrigger2(jobDetail));//同一个job添加多个trigger  
        scheduler.start();
    }

    private JobDetail buildJobDetail(){
        return JobBuilder.newJob(SimpleJobDemo1.class).withIdentity(new JobKey("job名称", "job组名称")).build();
    }
